  ...
  return (
    ...
    <div className="shared-hosting">
        <div className="heading-shared">
          <p className="main-heading-shared">  Premium Shared </p>
              ...
              <div className="pricing-card">
                <div className="top-content">
                  <div className="pricing-row">
                    ...
                    <div className="plan-title">Premium Primary</div>
                    <div className="plan-description">Best for one Website</div>
                    <div className="price">
                      <sup className="currency">₹</sup>
                      <span className="value">{isAnnually ? '1068.00' : '89.00'}</span>
                      <small>/</small>
              ...
              <div className="pricing-card">
                <div className="top-content">
                  <div className="pricing-row">
                    ...
                    <div className="plan-title">Premium Medium</div>
                    <div className="plan-description">Best for two Website</div>
                    <div className="price-content">
                      <div className="price">
                        <sup className="currency">₹</sup>
                        <span className="value">{isAnnually ? '1320.00' : '110.00'}</span>
                        <small>/</small>
                        <span className="period">{isAnnually ? 'Yearly' : 'Monthly'}</span>
                      </div>
                    </div>
              ...
              <div className="pricing-card">
                <div className="top-content">
                  <div className="pricing-row">
                    ...
                    <div className="plan-title">Premium Large</div>
                    <div className="plan-description">Best for five Website</div>
                    <div className="price-content">
                      <div className="price">
                        <sup className="currency">₹</sup>
                        <span className="value">{isAnnually ? '1560.00' : '130.00'}</span>
                        <small>/</small>
                        <span className="period">{isAnnually ? 'Yearly' : 'Monthly'}</span>
                      </div>
                    </div>
