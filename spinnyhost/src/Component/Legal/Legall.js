...
function Legall() {
    return (
        <div className="AllGeneral-Terms">
            <div>
                <div className='AllGeneral-Terms-header'>
                    <span>Legal</span>
                </div>
                <hr />
                <div className='AllGeneral-Terms-footer'>
                    <span>Procedure for Changing Authorised Email</span>
